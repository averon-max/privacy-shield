          ...
          <tr>
            <td style="padding-bottom:32px;">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td>
                    <span style="font-size:11px;font-weight:800;letter-spacing:0.2em;color:rgba(255,255,255,0.3);text-transform:uppercase;">SCANMYCREDS</span>
                  </td>
                  <td align="right">
                    <span style="font-size:10px;color:rgba(255,255,255,0.2);">Breach Monitoring Alert</span>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding-bottom:24px;">
              <table width="100%" cellpadding="0" cellspacing="0" style="background:rgba(224,92,75,0.08);border:1px solid rgba(224,92,75,0.35);border-radius:16px;overflow:hidden;">
                <!-- Top accent line -->
                <tr>
                  <td style="height:3px;background:linear-gradient(to right,#e05c4b,#b47fe8);font-size:0;">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <table cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="padding-right:10px;">
                          <a href="https://www.scanmycreds.com/app" style="display:inline-block;background:#fff;color:#000;font-weight:700;font-size:13px;padding:13px 28px;border-radius:9px;text-decoration:none;letter-spacing:-0.01em;">
                            View Full Report →
                          </a>
                        </td>
                        <td>
                          <a href="https://www.scanmycreds.com/app/tools" style="display:inline-block;background:rgba(255,255,255,0.06);color:rgba(255,255,255,0.6);font-weight:600;font-size:13px;padding:13px 20px;border-radius:9px;text-decoration:none;border:1px solid rgba(255,255,255,0.1);">
                            Change Password
                          </a>
                        </td>
                      </tr>
    ...
    for (const watched of watchedEmails) {
      try {
        ...
        if (currentCount > previousCount) {
          ...
          // Still update lastChecked even if no new breaches
          await WatchedEmail.findByIdAndUpdate(watched._id, {
            lastChecked: new Date(),
          });
        }
