...
export default function Login() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#000", color: "#fff", fontFamily: "'DM Sans', system-ui, sans-serif", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px", position: "relative", overflow: "hidden" }}>
      ...
      {/* Background glow */}
      <div style={{ position: "absolute", top: "30%", left: "50%", transform: "translate(-50%,-50%)", width: "600px", height: "400px", background: "radial-gradient(ellipse, rgba(108,158,247,0.06) 0%, transparent 70%)", pointerEvents: "none" }} />
      ...
      <div style={{ width: "100%", maxWidth: "420px", position: "relative", zIndex: 1, animation: mounted ? "fadeUp 0.6s ease both" : "none" }}>
        ...
        <div style={{ padding: "40px", borderRadius: "24px", border: "1px solid rgba(255,255,255,0.08)", background: "rgba(255,255,255,0.02)", backdropFilter: "blur(20px)", boxShadow: "0 0 80px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.06)" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "32px" }}>
            <p style={{ fontSize: "10px", letterSpacing: "0.25em", color: "rgba(255,255,255,0.2)", textTransform: "uppercase", marginBottom: "8px" }}>Welcome back</p>
            <h1 style={{ fontSize: "28px", fontWeight: 800, letterSpacing: "-0.04em", color: "#fff" }}>Sign in</h1>
          </div>
          ...
          <div style={{ textAlign: "right", marginBottom: "20px" }}>
            <Link href="/forgot-password" style={{ fontSize: "12px", color: "rgba(255,255,255,0.25)", textDecoration: "none", transition: "color 0.2s" }}
          ...
          <p style={{ textAlign: "center", fontSize: "13px", color: "rgba(255,255,255,0.2)", marginTop: "24px" }}>
            No account?{" "}
            <Link href="/register" style={{ color: "rgba(255,255,255,0.55)", textDecoration: "none", fontWeight: 600 }}
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: "20px", marginTop: "24px", flexWrap: "wrap" }}>
          {["k-Anonymity", "Zero data retention", "Free forever"].map(t => (
