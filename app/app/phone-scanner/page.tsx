  ...
  return (
    <div style={{ minHeight: "100vh", background: "#000", fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      ...
      <div style={{ maxWidth: "520px", margin: "0 auto", padding: "60px 16px" }}>
        ...
        {/* heading */}
        <h1 style={{ fontSize: "32px", fontWeight: 800, letterSpacing: "-0.04em", color: "#fff", textAlign: "center", marginBottom: "14px", lineHeight: 1.1 }}>
          Phone Scanner
        </h1>
        <p style={{ fontSize: "14px", color: "rgba(255,255,255,0.3)", textAlign: "center", lineHeight: 1.65, maxWidth: "360px", margin: "0 auto 48px" }}>
          We're integrating premium phone breach databases to check SMS leaks, spam records, and carrier data exposure. Almost ready.
        </p>
        ...
        <div style={{ border: "1px solid rgba(255,255,255,0.06)", borderRadius: "16px", overflow: "hidden", marginBottom: "24px" }}>
          {[
            ...
            { color: "#c48b20", title: "Spam database scan", desc: "See if your number is on known spam/robocall lists" },
