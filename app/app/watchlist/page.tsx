  ...
  return (
    <PageShell eyebrow="Breach monitoring" title="Watchlist" subtitle="Add emails to monitor. Get alerted instantly when a new breach is detected.">
      <Card>
        ...
        {atLimit && (
          <p style={{ fontSize: "11px", color: "#e05c4b", marginTop: "10px" }}>
            Limit reached · <Link href="/pricing" style={{ color: "#6c9ef7", textDecoration: "underline" }}>Upgrade to Pro for unlimited →</Link>
          </p>
        )}
      </Card>
        ...
        <Card key={e._id || e.email}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "12px" }}>
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                <span style={{ fontSize: "10px", padding: "3px 9px", borderRadius: "5px", background: "rgba(108,228,192,0.08)", color: "#6ce4c0", border: "1px solid rgba(108,228,192,0.2)", fontWeight: 600, letterSpacing: "0.05em", textTransform: "uppercase" }}>Monitoring</span>
                ...
                {e.lastBreachCount !== undefined && e.lastBreachCount > 0 && (
                  <span style={{ fontSize: "10px", padding: "3px 9px", borderRadius: "5px", background: "rgba(224,92,75,0.08)", color: "#e05c4b", border: "1px solid rgba(224,92,75,0.2)", fontWeight: 600 }}>{e.lastBreachCount} breaches</span>
                )}
              </div>
            </div>
      ...
      <Card>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
          {[
            { c: "#6c9ef7", t: "Emails checked against breach databases every 24 hours" },
            { c: "#b47fe8", t: "Instant email alert if a new breach is detected" },
            { c: "#6ce4c0", t: "Free: monitor up to 3 emails · Pro: unlimited" },
          ].map((x, i) => (
            <div key={i} style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              <span style={{ width: "5px", height: "5px", borderRadius: "50%", background: x.c, boxShadow: "0 0 6px " + x.c, flexShrink: 0 }} />
              <p style={{ fontSize: "12px", color: "rgba(255,255,255,0.5)" }}>{x.t}</p>
            </div>
          ))}
        </div>
      </Card>
