    ...
    <div style={{ minHeight: "100vh", background: "#050508", color: "#fff", fontFamily: "'DM Sans', system-ui, sans-serif", overflowX: "hidden" }}>
      ...
      <section style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "120px 20px 80px", position: "relative" }}>
        ...
        <div style={{ width: "100%", maxWidth: "500px", position: "relative", zIndex: 2, opacity: mounted ? 1 : 0, transform: mounted ? "translateY(0)" : "translateY(16px)", transition: "all 0.9s ease 0.4s" }}>
          <div style={{ position: "absolute", inset: "-20px", borderRadius: "32px", background: "linear-gradient(135deg, #00d4ff, #b47fe8, #e84393)", opacity: inputFocus ? 0.35 : 0.12, filter: "blur(28px)", transition: "opacity 0.4s ease", pointerEvents: "none" }} />
          <div style={{ border: "1px solid " + (inputFocus ? "rgba(180,127,232,0.5)" : "rgba(255,255,255,0.1)"), borderRadius: "20px", padding: "20px", background: "rgba(13,13,20,0.85)", backdropFilter: "blur(20px)", boxShadow: inputFocus ? "0 0 60px rgba(180,127,232,0.2)" : "0 0 40px rgba(108,158,247,0.05)", transition: "all 0.3s ease", position: "relative" }}>
          ...
          {steps.map((s, i) => (
            <FadeIn key={s.num} delay={i * 0.15}>
              <div style={{ padding: "28px 24px", borderRadius: "16px", border: "1px solid " + s.color + "30", background: "linear-gradient(135deg, " + s.color + "0d, rgba(13,13,20,0.6))", height: "100%", transition: "all 0.35s ease", cursor: "default", position: "relative", overflow: "hidden", backdropFilter: "blur(10px)" }}
                ...
                <div style={{ width: "48px", height: "48px", borderRadius: "14px", background: "linear-gradient(135deg, " + s.color + ", " + s.color + "88)", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "20px", boxShadow: "0 0 24px " + s.color + "66" }}><span style={{ fontSize: "20px", fontWeight: 900, color: "#000" }}>{s.num}</span></div>
                <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "10px" }}><span style={{ fontSize: "20px", color: s.color }}>{s.icon}</span><h3 style={{ fontSize: "20px", fontWeight: 800, color: "#fff", letterSpacing: "-0.02em" }}>{s.title}</h3></div>
      ...
      <section style={{ padding: "60px 20px 80px", maxWidth: "1000px", margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "14px" }}>
          {[{ val: "15B+", label: "records checked", color: "#00d4ff" }, { val: "847", label: "breaches caught this week", color: "#e05c4b" }, { val: "4.9★", label: "average rating", color: "#a8e63d" }].map((s, i) => (
            <FadeIn key={s.label} delay={i * 0.1}>
              <div style={{ padding: "28px 24px", borderRadius: "16px", border: "1px solid " + s.color + "25", background: "linear-gradient(135deg, " + s.color + "08, rgba(13,13,20,0.8))", textAlign: "center", position: "relative", overflow: "hidden", transition: "all 0.3s ease" }}
                ...
                <p style={{ fontSize: "44px", fontWeight: 900, color: s.color, letterSpacing: "-0.03em", lineHeight: 1, textShadow: "0 0 30px " + s.color + "55", marginBottom: "10px" }}>{s.val}</p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: "14px", alignItems: "start" }}>
            ...
            <FadeIn delay={0.05}>
              <div style={{ background: "#0d0d14", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "16px", padding: "28px" }}>
                ...
                <Link href="/launch" style={{ display: "block", textAlign: "center", padding: "13px", fontSize: "14px", fontWeight: 700, color: "rgba(255,255,255,0.7)", background: "transparent", border: "1px solid rgba(255,255,255,0.15)", borderRadius: "10px", textDecoration: "none", transition: "all 0.2s" }}
                  ...
                  onMouseLeave={e => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.color = "rgba(255,255,255,0.7)"; e.currentTarget.style.borderColor = "rgba(255,255,255,0.15)"; }}>
                  Get Started Free
                </Link>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={0.12}>
              <div style={{ background: "rgba(180,127,232,0.07)", border: "1px solid rgba(180,127,232,0.35)", borderRadius: "16px", padding: "28px", position: "relative", overflow: "hidden", boxShadow: "0 0 60px rgba(180,127,232,0.08)" }}>
                ...
                <p style={{ fontSize: "11px", letterSpacing: "0.15em", color: "#b47fe8", fontWeight: 700, marginBottom: "16px" }}>PRO</p>
      ...
      <section style={{ padding: "100px 20px 120px", borderTop: "1px solid rgba(255,255,255,0.06)", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <FadeIn>
          ...
          <Link href="/launch" style={{ display: "inline-block", padding: "18px 48px", fontSize: "16px", fontWeight: 800, color: "#000", background: "#fff", textDecoration: "none", borderRadius: "14px", boxShadow: "0 0 60px rgba(255,255,255,0.5), 0 0 120px rgba(180,127,232,0.15)", transition: "all 0.25s", position: "relative", zIndex: 2 }}
